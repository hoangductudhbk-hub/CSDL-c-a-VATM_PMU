      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden', minWidth:0 }}>
        ...
        {tab === 'guide' && (() => {
          const guideItems = [
            ...
            { num:'3', title:'Trợ lý AI', icon:'✨', content:'Nhấn <b>💬 Hỏi đáp tài liệu</b> để hỏi các thông tin chính được AI ghi nhớ lại trong văn bản. <b>1 dự án/gói thầu:</b> khung <b>✨ Trợ lý AI</b> phía dưới. <b>Cả nhóm:</b> bấm tên nhóm ở sidebar. AI trả lời đúng nội dung gốc, không bịa.' },
