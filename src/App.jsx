          ...
          <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
            ...
            <div style={{ flex:1, padding:'10px 20px', overflow:'hidden', display:'flex', flexDirection:'column' }}>
              ...
              {[
                ...
                { num:'4', title:'Phân tích tài liệu bằng AI', icon:'🤖', content:'Nhấn vào tên văn bản để mở chi tiết → cuộn xuống phần <b>Phân tích AI</b>. Văn bản mới tự động phân tích ngay sau khi upload. Nhấn <b>📊 Phân tích tài liệu</b> nếu chưa có, hoặc <b>🔄 Phân tích lại</b> để đọc lại từ đầu.' },
