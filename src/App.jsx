        ...
        {tab === 'guide' && (
          <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
            ...
            <div style={{ flex:1, padding:'10px 20px', overflowY:'auto', display:'flex', flexDirection:'column' }}>
              ...
              {[
                { num:'1', title:'Thêm văn bản — đúng theo từng nhóm', icon:'📁', content:'<b>DỰ ÁN:</b> phải vào đến <b>gói thầu</b> (lớp 3) mới thêm được văn bản, không thêm được ở lớp dự án hay lớp tổng. <b>QUY ĐỊNH / BIỂU MẪU:</b> thêm được ngay khi vào đúng mục cụ thể (lớp 2), không cần lớp gói thầu. Lớp tổng (tên nhóm) ở cả 3 nhóm đều <b>không</b> thêm văn bản trực tiếp được.' },
                { num:'2', title:'Upload văn bản bằng AI', icon:'✨', content:'Nhấn <b>+ Thêm văn bản</b> → tab <b>✨ AI tự điền</b> → chọn file <b>PDF/Word/Excel</b> (Ctrl+Click chọn nhiều file). AI đọc trực tiếp qua <b>ảnh (Vision)</b> cho Số ký hiệu/Ngày/Cơ quan — đọc đúng cả file scan mờ, lệch font, không chỉ dựa vào lớp text PDF. Thiếu Số/Ngày sau khi điền sẽ tự hiện cảnh báo "cần kiểm tra lại".' },
