        ...
        {tab === 'guide' && (
          <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
            ...
            <div style={{ flex:1, padding:'10px 20px', overflow:'hidden', display:'flex', flexDirection:'column' }}>
              ...
              {[
                { num:'1', title:'Chọn dự án & gói thầu', icon:'📁', content:'Dự án hiển thị ở <b>thanh bên trái</b>. Nhấn <b>▶</b> để mở rộng xem gói thầu. Nhấn vào <b>📁 tên gói thầu</b> để xem danh sách văn bản của gói đó.' },
                { num:'2', title:'Upload văn bản bằng AI', icon:'✨', content:'Nhấn <b>+ Thêm văn bản</b> → chọn tab <b>✨ AI tự điền</b> → chọn file <b>PDF / Word / Excel</b> → AI tự đọc và điền thông tin. Giữ <b>Ctrl+Click</b> để chọn nhiều file cùng lúc.' },
                { num:'3', title:'Upload văn bản thủ công', icon:'✏️', content:'Nhấn <b>+ Thêm văn bản</b> → tab <b>✏️ Nhập thủ công</b> → điền Số ký hiệu, Ngày, Cơ quan, Loại, Nội dung, Trạng thái → đính kèm file nếu có → nhấn <b>Thêm văn bản</b>.' },
                { num:'4', title:'Phân tích tài liệu bằng AI', icon:'🤖', content:'Nhấn vào tên văn bản để mở chi tiết → cuộn xuống phần <b>Phân tích AI</b>. Văn bản mới tự động phân tích ngay sau khi upload — kể cả file scan/ảnh chụp chất lượng kém, AI sẽ đọc trực tiếp qua hình ảnh để đảm bảo độ chính xác. Nhấn <b>📊 Phân tích tài liệu</b> nếu chưa có, hoặc <b>🔄 Phân tích lại</b> để đọc lại từ đầu.' },
                { num:'5', title:'Hỏi đáp AI về nội dung', icon:'💬', content:'Sau khi phân tích xong, nhấn <b>💬 Hỏi đáp</b> để mở khung chat. Đặt câu hỏi bất kỳ về nội dung tài liệu — AI đọc toàn bộ văn bản và trả lời chi tiết. Dùng để tra cứu điều khoản, số liệu, tiến độ nhanh.' },
                { num:'6', title:'Xem, sửa và xóa văn bản', icon:'📄', content:'<b>Nhấn vào dòng</b> để xem chi tiết & tải file gốc. Nhấn <b>✏️</b> để chỉnh sửa thông tin. Nhấn <b>🗑️</b> để xóa — file và toàn bộ dữ liệu AI sẽ bị xóa theo. Nhấn vào <b>trạng thái</b> để cập nhật tiến độ nhanh.' },
                { num:'7', title:'Trợ lý AI cấp dự án', icon:'📊', content:'Khi xem dự án (không mở văn bản cụ thể), phần <b>✨ Trợ lý AI</b> phía dưới cho phép hỏi về toàn bộ dự án. Dùng nút <b>📋 Tóm tắt</b>, <b>🔴 Việc gấp</b>, <b>📊 Báo cáo</b>, <b>⚠️ Rủi ro</b> hoặc tự nhập câu hỏi.' },
                { num:'8', title:'Xuất báo cáo Word', icon:'📥', content:'Chọn dự án hoặc gói thầu → tab <b>Xuất báo cáo</b> → nhấn <b>📥 Tải báo cáo Word</b>. File Word tổng hợp toàn bộ văn bản trong phạm vi đang chọn sẽ được tải về máy.' },
              ].map(item => (
